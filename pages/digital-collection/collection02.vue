...
export default {
  ...
  data: () => ({
    ...
    commentary: [
      {
        p: 'フェリス女学院大学図書館では2004年度に絵入り竹取物語写本三冊を貴重書として購入しました。紺地金襴表紙のこの竹取物語は、二十四枚の極彩色の絵を伴っており、これは、竹取物語の絵入本としてはもっとも多い絵を含む新出写本であり、しかもその絵には際立った個性が認められます。',
      },
      {
        p: 'フェリス本は縦二十四センチ、横17センチ、上・中・下三冊本で、上巻の墨付き四十六丁、絵十一枚、中巻墨付き三十二丁、絵七枚、下巻墨付き三十九丁、絵六枚です。料紙は斐紙。見返しには金の切箔が散らされています。一行十六・七字、十行程度です。絵の前の本文は散らし書きされるのが通例で、絵の場面に合わせて、本文が書かれています。筆跡は手馴れた達筆です。',
      },
      {
        p: '一般に絵入竹取物語は十枚から十五・六枚の絵を入れることが多く、本文を持たない絵だけの竹取物語絵に、三十枚を持つものもありますが、これを例外とすれば、二十四枚の絵を持つフェリス本は、本文と絵の両方を含む本としては、もっとも、絵の数が多いといえます。現存場面では他に類例のない場面、五人の求婚者がかぐや姫に求婚して、竹取翁に臥し拝む場面、くらもちの皇子の蓬莱山での女性（うかんるり）との出会いを語る作り話の場面、中国の商人「王けい」が火鼠の皮衣を砂金で売りつける場面を含んでいます。',
      },
    ],
    commentary2: [
      {
