<template>
  <v-container>
    ...
    <v-alert
      ...
      elevation="2"
    >
      <p>各学科の専任教員が「〇〇学科の学生なら読んでおいてほしい本」として選定された図書です。</p>
      <p>専門分野、履修科目に関わらず、所属学科における基本知識として読むことが期待されています。</p>
      <p><v-chip class="mr-2">配架場所</v-chip>緑園本館2階（図書館エリア／メディアカウンター向かい）</p>
